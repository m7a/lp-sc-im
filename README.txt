`mdvl-sc-im` package for sc-im, an improved spreadsheet calculator based on sc.
See <https://github.com/andmarti1424/sc-im>.
This package builds sc-im with support for libxlsxwriter, see
